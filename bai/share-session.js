// bai/share-session.js
//
// Снимает «живую» сессию аккаунта B.AI (cookies bai.ai + localStorage) в
// Playwright storageState-формате и сохраняет в bai/sessions/<label>.json.
//
// Использование:
//   node bai/share-session.js <label>
