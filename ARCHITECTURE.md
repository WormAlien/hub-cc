...
дней общий итог - на этом Лига расходилась с `/stats` на 21 %. Прежняя метрика оставлена
как есть (другое определение, своя кнопка), а рейтинг переехал на `ccStats` с версией
определения. Участник без `ccStats` места не получает вовсе: прочерк и причина, а не ноль.
