// wisdomsatan/share-session.js
//
// Снимает «живую» сессию аккаунта WisdomSatan (cookies GitHub + wisdomsatan + localStorage)
// в Playwright storageState-формате и сохраняет в wisdomsatan/sessions/<label>.json.
//
// Использование:
//   node wisdomsatan/share-session.js <label>
