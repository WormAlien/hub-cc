...
//
// Снимает «живую» сессию аккаунта UniKey (cookies getunikey.ai + localStorage) в
// Playwright storageState-формате и сохраняет в getunikey/sessions/<label>.json.
//
// Использование:
//   node getunikey/share-session.js <label>
